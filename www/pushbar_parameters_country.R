          ...
          fluidRow(
            ...
            column(4,
                   pickerInput("country_demographic", label = "Demographic Data:", choices = countries_demographic,
                               selected = "Thailand", options = pickerOptions(liveSearch = TRUE)),
                   pickerInput("province_cases", label = "Cases/Deaths:", choices = provinces_cases, ## 
                               selected = "Yala", options = pickerOptions(liveSearch = TRUE))
            ),
            column(4,
